...
Atualizada em 21/09/2026. Fonte do estado vigente: [implementações](../../docs/00-project/IMPLEMENTATION_STATUS.md). Os números abaixo são resultados datados, não nova consulta. Não guardar credenciais ou resultados presumidos.
