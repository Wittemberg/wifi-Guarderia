...
Inventário de recursos e rede da RB750r2 r3 recebido, RouterOS/RouterBOOT 7.23.7. Gateway em uso confirmado pelo usuário; sem homologação de carga, VPN, firewall externo da RB ou segundo link. Evidências da VPS permanecem válidas nos respectivos escopos registrados.
