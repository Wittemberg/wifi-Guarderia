...
- Acesso/inventário da RB951G, integração das RBs, templates/coleta de equipamentos, RF, energia, isolamento de barcos e PoC de campo ainda pendentes. Atualização RouterOS/RouterBOOT da RB951G foi confirmada pelo usuário; não equivale à integração.
