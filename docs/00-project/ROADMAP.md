...
| F1 | Inventário VPS, RBs e levantamento local | F0 | HW-01/VPS-01 e pendências impeditivas resolvidas | Pendente |
...
Inventariar VPS sem alterações: SO, CPU/RAM, disco, IPs, Docker, modo Compose/Swarm, Portainer, redes, volumes e serviços existentes. Conferir RouterOS e modelo das RBs. Preencher pendências `OPEN-01` a `OPEN-05` antes de produzir scripts aplicáveis.
